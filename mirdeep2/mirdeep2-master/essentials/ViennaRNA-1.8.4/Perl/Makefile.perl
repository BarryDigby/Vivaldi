...
test_static :: subdirs-test_static $(MAP_TARGET)
	PERL_DL_NONLAZY=1 "/home/barry/Desktop/Owen_Donohue/mirdeep2/mirdeep2-master/essentials/ViennaRNA-1.8.4/Perl/$(MAP_TARGET)" $(MAP_PERLINC) "-I$(INST_LIB)" "-I$(INST_ARCHLIB)" $(TEST_FILE)
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="RNA" VERSION="0.2">' > RNA.ppd
	...
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.26" />' >> RNA.ppd
